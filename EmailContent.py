...
def email_send(attachment_path):
                    ...
                    if email_ids:
                        ...
                        for email_id in reversed(email_ids):
                            ...
                            if result == "OK":
                                ...
                                # to_email = 'rajesh.yerremshetty@unicorntechmedia.com'
                                # cc_email_list = ['mohit.lalwani@unicorntechmedia.com', 'nisha.singh@unicorntechmedia.com', 'ankur.kataria@unicorntechmedia.com', 'arun.reddy@newgendigital.com', 'Ashish.Thakur@tvsmotor.com', 'Neha.Parasher@tvsmotor.com', 'Prasanth.S@tvsmotor.com', 'priyadharshini@newgendigital.com', 'punitha@newgendigital.com']
                                from_email='ajithkumaraji9047@gmail.com'
                                to_email='ajithkumar@newgendigital.com'
                                subject = f"{msg['Subject']}"
                                cc_email_list =['selvaganapathiannadurai001@gmail.com']
    ...
    imap_password = "uroqpjoiixmnrxxb"

    smtp_server = "smtp.gmail.com"
    smtp_port = 587
    smtp_username = "ajithkumar@newgendigital.com"
    smtp_password = "uroqpjoiixmnrxxb"
